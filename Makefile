...
EXTENSIONS  ?= InterruptsM,InterruptsS,ZicsrM # I,M,F,D,Zca,Zcf,Zcd,Zaamo,Zalrsc,Zifencei # Extensions to generate tests for. Leave blank to generate for all tests.
